...
<?php
  ...
  require_once('connectvars.php');
    ...
    echo '<p><strong>나라: </strong>' . $country . '<br /><strong>도시: </strong>' . $city .
      '<br /><strong>대상: </strong>' . $product . '</p>';
    echo '<p><strong>가격: </strong>' . $currency . '<br /><strong>cost: </strong>' . $cost .
       '</p>';
  ...
  echo '<p><a href="admin_k.php">&lt;&lt; Back to remove page</a></p>';
?>
